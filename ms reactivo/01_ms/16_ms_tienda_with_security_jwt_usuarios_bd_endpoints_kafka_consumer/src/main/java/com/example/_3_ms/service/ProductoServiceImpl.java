...
import com.example._3_ms.model.Pedido;
...
public class ProductoServiceImpl implements ProductoService{
    ...
    @KafkaListener(topics="topicTest", groupId = "myGroup1")
    public void gesttionPedido(Pedido pedido){
        productoCodigo(pedido.getCodProducto())
                .flatMap(pr -> {
